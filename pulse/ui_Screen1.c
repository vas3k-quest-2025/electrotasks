...
lv_obj_t *uic_codeword;
lv_obj_t *uic_pulse_label;
lv_obj_t *uic_bpm_label;
lv_obj_t *uic_bpm_arc;
lv_obj_t *ui_Screen1;
lv_obj_t *ui_Arc1;
lv_obj_t *ui_Label1;
lv_obj_t *ui_Label2;
...
lv_label_set_text(ui_Label1,"123");
...
lv_label_set_text(ui_Label2,"пульс\n\nуд/мин");
...
lv_label_set_text(ui_Label3,"Кодовое слово:\n?????????");
...
uic_bpm_arc = ui_Arc1;
uic_bpm_label = ui_Label1;
uic_pulse_label = ui_Label2;
uic_codeword = ui_Label3;
